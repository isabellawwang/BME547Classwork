...
def input_HDL():
    ...
    return int(user_HDL)  # convert string into integer
...
def output_HDL_result(hdl_value, hdl_charac):
    print("The result for an HDL value of {} is {}".
          format(hdl_value, hdl_charac))


def HDL_driver():  # calls functions; moves variables b/t them
    HDL_value = input_HDL()
...
def output_LDL_result(ldl_value, ldl_charac):
    print("The result for an LSL value of {} is {}.".
          format(ldl_value, ldl_charac))
