...
def calculate_dose_amount(diagnosis, weight):
...
def dose_amount_driver():
    patient_diagnosis = get_diagnosis()
    patient_weight = get_weight()
    calculate_dose_amount(patient_diagnosis, patient_weight)
